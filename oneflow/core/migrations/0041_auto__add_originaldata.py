...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OriginalData'
        db.create_table(u'core_originaldata', (
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(related_name='original_data', unique=True, primary_key=True, to=orm['core.BaseItem'])),
            ('google_reader', self.gf('django.db.models.fields.TextField')()),
            ('feedparser', self.gf('django.db.models.fields.TextField')()),
            ('raw_email', self.gf('django.db.models.fields.TextField')()),
            ('google_reader_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('feedparser_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('raw_email_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['OriginalData'])


    def backwards(self, orm):
        # Deleting model 'OriginalData'
        db.delete_table(u'core_originaldata')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '060b86ea365545e4a6e517615b641157'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
