...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_folder', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Folder.image'
        db.add_column(u'core_folder', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Folder.image_url'
        db.add_column(u'core_folder', 'image_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_folder', 'slug')

        # Deleting field 'Folder.image'
        db.delete_column(u'core_folder', 'image')

        # Deleting field 'Folder.image_url'
        db.delete_column(u'core_folder', 'image_url')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'dc514a0e85cc4151855d9e28d1b99ed2'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'44203cfdd872407fbcbda7e010f39b9d'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'482afa2543f24603aef59aefa496ef1c'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5f1a1951aa224366a3e56de9cbd6c8a7'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.usercounters': {
