...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tags on 'BaseFeed'
        m2m_table_name = db.shorten_name(u'core_basefeed_tags')
        ...
        db.create_unique(m2m_table_name, ['basefeed_id', 'simpletag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tags on 'BaseFeed'
        db.delete_table(db.shorten_name(u'core_basefeed_tags'))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'c74dd52af3ba4c5c9d4c0348c6488b40'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
