...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterFeed.backfill'
        db.delete_column(u'core_twitterfeed', 'backfill')

        # Adding field 'TwitterFeed.is_backfilled'
        db.add_column(u'core_twitterfeed', 'is_backfilled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterFeed.track_terms'
        db.add_column(u'core_twitterfeed', 'track_terms',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TwitterFeed.track_locations'
        db.add_column(u'core_twitterfeed', 'track_locations',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TwitterFeed.backfill'
        db.add_column(u'core_twitterfeed', 'backfill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TwitterFeed.is_backfilled'
        db.delete_column(u'core_twitterfeed', 'is_backfilled')

        # Deleting field 'TwitterFeed.track_terms'
        db.delete_column(u'core_twitterfeed', 'track_terms')

        # Deleting field 'TwitterFeed.track_locations'
        db.delete_column(u'core_twitterfeed', 'track_locations')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '4f315bbc53e444a2ab5e6a3bc415c66f'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'0fa220c3e4f5413bb3ffb73b833e2bff'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'2f4e5ba271a14035af6cf9f4dcfd2fdb'", 'max_length': '32', 'blank': 'True'}),
