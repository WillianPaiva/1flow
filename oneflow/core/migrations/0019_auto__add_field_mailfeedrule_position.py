...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailFeedRule.position'
        db.add_column(u'core_mailfeedrule', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailFeedRule.position'
        db.delete_column(u'core_mailfeedrule', 'position')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '7c16fe87f8cf43c8a1bbce5bfa499b67'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
