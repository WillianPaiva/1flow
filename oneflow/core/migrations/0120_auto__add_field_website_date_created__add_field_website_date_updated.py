...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebSite.date_created'
        db.add_column(u'core_website', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 2, 14, 0, 0), db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'WebSite.date_updated'
        db.add_column(u'core_website', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 2, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebSite.date_created'
        db.delete_column(u'core_website', 'date_created')

        # Deleting field 'WebSite.date_updated'
        db.delete_column(u'core_website', 'date_updated')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'af71ffdd11f2484eb36222ca2c8627b6'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'75f88024960641a1853733d51aaf0b98'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'d0402a9eae944bbfb3aedf52c5c4f87d'", 'max_length': '32', 'blank': 'True'}),
