...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SelectorPreferences'
        db.create_table(u'core_selectorpreferences', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='selector', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('titles_show_unread_count', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('lists_show_unread_count', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('folders_show_unread_count', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('extended_folders_depth', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('subscriptions_in_multiple_folders', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_closed_streams', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['SelectorPreferences'])

        # Adding model 'SnapPreferences'
        db.create_table(u'core_snappreferences', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='snap', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('select_paragraph', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('default_public', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('core', ['SnapPreferences'])

        # Adding model 'HelpWizards'
        db.create_table(u'core_helpwizards', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='wizards', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('show_all', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('welcome_beta_shown', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['HelpWizards'])

        # Adding model 'SharePreferences'
        db.create_table(u'core_sharepreferences', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='share', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('default_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['SharePreferences'])

        # Adding model 'ReadPreferences'
        db.create_table(u'core_readpreferences', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='read', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('starred_marks_read', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('starred_marks_archived', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('bookmarked_marks_archived', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('watch_attributes_mark_archived', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('starred_removes_bookmarked', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('bookmarked_marks_unread', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('reading_speed', self.gf('django.db.models.fields.IntegerField')(default=200, blank=True)),
            ('auto_mark_read_delay', self.gf('django.db.models.fields.IntegerField')(default=4500, blank=True)),
            ('read_switches_to_fullscreen', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_bottom_navbar', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['ReadPreferences'])

        # Adding model 'HomePreferences'
        db.create_table(u'core_homepreferences', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='home', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('style', self.gf('django.db.models.fields.CharField')(default=u'RL', max_length=2, blank=True)),
            ('show_advanced_preferences', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('read_shows', self.gf('django.db.models.fields.IntegerField')(default=2, blank=True)),
            ('experimental_features', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['HomePreferences'])

        # Adding model 'StaffPreferences'
        db.create_table(u'core_staffpreferences', (
            ('preferences', self.gf('django.db.models.fields.related.OneToOneField')(related_name='staff', unique=True, primary_key=True, to=orm['core.Preferences'])),
            ('super_powers_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('reading_lists_show_bad_articles', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('selector_shows_admin_links', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('no_home_redirect', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_all_articles', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['StaffPreferences'])

        # Adding model 'Preferences'
        db.create_table(u'core_preferences', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['base.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('core', ['Preferences'])


    def backwards(self, orm):
        # Deleting model 'SelectorPreferences'
        db.delete_table(u'core_selectorpreferences')

        # Deleting model 'SnapPreferences'
        db.delete_table(u'core_snappreferences')

        # Deleting model 'HelpWizards'
        db.delete_table(u'core_helpwizards')

        # Deleting model 'SharePreferences'
        db.delete_table(u'core_sharepreferences')

        # Deleting model 'ReadPreferences'
        db.delete_table(u'core_readpreferences')

        # Deleting model 'HomePreferences'
        db.delete_table(u'core_homepreferences')

        # Deleting model 'StaffPreferences'
        db.delete_table(u'core_staffpreferences')

        # Deleting model 'Preferences'
        db.delete_table(u'core_preferences')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '6d56f2b59abb4f77b99a43e99056f28a'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
