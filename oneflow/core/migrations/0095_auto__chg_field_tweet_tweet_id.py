...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_tweet', 'tweet_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True))

    def backwards(self, orm):

        # Changing field 'Tweet.tweet_id'
        db.alter_column(u'core_tweet', 'tweet_id', self.gf('django.db.models.fields.IntegerField')(unique=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '7172af6146c9486b8e6fb4cd9c6ca761'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'b8e79fbb45ec42ef8d801261718ecff5'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'0aa3a8d1658147c78f8d4aefe63a005f'", 'max_length': '32', 'blank': 'True'}),
