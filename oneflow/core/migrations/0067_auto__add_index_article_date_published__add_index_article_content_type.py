...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Article', fields ['date_published']
        db.create_index(u'core_article', ['date_published'])

        # Adding index on 'Article', fields ['content_type']
        db.create_index(u'core_article', ['content_type'])

        # Adding index on 'BaseFeed', fields ['date_last_fetch']
        db.create_index(u'core_basefeed', ['date_last_fetch'])

        # Adding index on 'BaseFeed', fields ['is_good']
        db.create_index(u'core_basefeed', ['is_good'])


    def backwards(self, orm):
        # Removing index on 'BaseFeed', fields ['is_good']
        db.delete_index(u'core_basefeed', ['is_good'])

        # Removing index on 'BaseFeed', fields ['date_last_fetch']
        db.delete_index(u'core_basefeed', ['date_last_fetch'])

        # Removing index on 'Article', fields ['content_type']
        db.delete_index(u'core_article', ['content_type'])

        # Removing index on 'Article', fields ['date_published']
        db.delete_index(u'core_article', ['date_published'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '8fbd83f32e3a4cc0bdd868b127e95ff2'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'b4095cf75fce4c4cbba66aacc3f89f19'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'a5dee1e720ff4fd690a6f41c9614b3e5'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'85a0f51a58d9434ba30ad52f78d67be2'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
