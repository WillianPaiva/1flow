...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseItem.duplicate_of'
        db.alter_column(u'core_baseitem', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseItem'], null=True))

        # Changing field 'Author.duplicate_of'
        db.alter_column(u'core_author', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Author'], null=True))

        # Changing field 'SimpleTag.duplicate_of'
        db.alter_column(u'core_simpletag', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SimpleTag'], null=True))

        # Changing field 'Language.duplicate_of'
        db.alter_column(u'core_language', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BaseItem.duplicate_of'
        raise RuntimeError("Cannot reverse this migration. 'BaseItem.duplicate_of' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BaseItem.duplicate_of'
        db.alter_column(u'core_baseitem', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseItem']))

        # User chose to not deal with backwards NULL issues for 'Author.duplicate_of'
        raise RuntimeError("Cannot reverse this migration. 'Author.duplicate_of' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Author.duplicate_of'
        db.alter_column(u'core_author', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Author']))

        # User chose to not deal with backwards NULL issues for 'SimpleTag.duplicate_of'
        raise RuntimeError("Cannot reverse this migration. 'SimpleTag.duplicate_of' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SimpleTag.duplicate_of'
        db.alter_column(u'core_simpletag', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SimpleTag']))

        # User chose to not deal with backwards NULL issues for 'Language.duplicate_of'
        raise RuntimeError("Cannot reverse this migration. 'Language.duplicate_of' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Language.duplicate_of'
        db.alter_column(u'core_language', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language']))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'fe62326b53744fb9b828a050713c8efc'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
