...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SimpleTag.name'
        db.alter_column(u'core_simpletag', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'SimpleTag.slug'
        db.alter_column(u'core_simpletag', 'slug', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'SimpleTag.name'
        db.alter_column(u'core_simpletag', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'SimpleTag.slug'
        db.alter_column(u'core_simpletag', 'slug', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '0b3aa62bc4b24785b32809e9df00b2b6'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'4db779196a234c3dab0d23788f74edd3'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'57718b20aeca4dff82fa74b2709a6492'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fb626f839c3a47b39fd4990b5ebaa10d'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
