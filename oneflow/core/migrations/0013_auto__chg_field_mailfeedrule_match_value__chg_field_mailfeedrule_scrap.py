...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailFeedRule.scrap_refine'
        db.alter_column(u'core_mailfeedrule', 'scrap_refine', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'MailFeedRule.match_value'
        db.alter_column(u'core_mailfeedrule', 'match_value', self.gf('django.db.models.fields.TextField')())

        # Changing field 'MailFeedRule.scrap_refine'
        db.alter_column(u'core_mailfeedrule', 'scrap_refine', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'd5ec4169aab74a9d9e12434232f7f5a0'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.mailfeedrule': {
            ...
            'scrap_refine': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'})
        }
    }
