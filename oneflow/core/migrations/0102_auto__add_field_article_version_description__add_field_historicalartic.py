...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.version_description'
        db.add_column(u'core_article', 'version_description',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalArticle.version_description'
        db.add_column(u'core_historicalarticle', 'version_description',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.version_description'
        db.delete_column(u'core_article', 'version_description')

        # Deleting field 'HistoricalArticle.version_description'
        db.delete_column(u'core_historicalarticle', 'version_description')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'd6cdaa6975084a5f8e21fe7099889f0c'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'9c1c124f727248149227ad6eb76e6de0'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'4e0a28c774c24833b0381a91098b2d73'", 'max_length': '32', 'blank': 'True'}),
