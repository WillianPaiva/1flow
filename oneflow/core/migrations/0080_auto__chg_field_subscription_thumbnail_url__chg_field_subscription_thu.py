...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.thumbnail_url'
        db.alter_column(u'core_subscription', 'thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True))

        # Changing field 'Subscription.thumbnail'
        db.alter_column(u'core_subscription', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

        # Changing field 'Folder.image'
        db.alter_column(u'core_folder', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

        # Changing field 'Folder.image_url'
        db.alter_column(u'core_folder', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True))

        # Changing field 'WebSite.image'
        db.alter_column(u'core_website', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

        # Changing field 'WebSite.image_url'
        db.alter_column(u'core_website', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True))

        # Changing field 'BaseFeed.thumbnail'
        db.alter_column(u'core_basefeed', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

        # Changing field 'BaseFeed.thumbnail_url'
        db.alter_column(u'core_basefeed', 'thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True))

    def backwards(self, orm):

        # Changing field 'Subscription.thumbnail_url'
        db.alter_column(u'core_subscription', 'thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Subscription.thumbnail'
        db.alter_column(u'core_subscription', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Folder.image'
        db.alter_column(u'core_folder', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Folder.image_url'
        db.alter_column(u'core_folder', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'WebSite.image'
        db.alter_column(u'core_website', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'WebSite.image_url'
        db.alter_column(u'core_website', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'BaseFeed.thumbnail'
        db.alter_column(u'core_basefeed', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'BaseFeed.thumbnail_url'
        db.alter_column(u'core_basefeed', 'thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '35ce238ea1454fc3b0c34d93f3059b34'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'4ff6088bf64b43e5a407e702a0cc09df'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'317cc11ed1be4952bb3c22a185a57743'", 'max_length': '32', 'blank': 'True'}),
