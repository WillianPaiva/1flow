...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncNode.status'
        db.add_column(u'core_syncnode', 'status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SyncNode.status'
        db.delete_column(u'core_syncnode', 'status')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'a984b656a97b451ea66b1f1fc38d45f2'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'27dca32861e546cb86b56f4aadcb1c4e'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'7b7e5ccfc1794c8bb9c86c29e98baeb4'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'091a08da59b240e798df2db314e121fa'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
