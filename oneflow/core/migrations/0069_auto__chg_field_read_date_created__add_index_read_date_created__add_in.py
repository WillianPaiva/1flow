...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Read.date_created'
        db.alter_column(u'core_read', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding index on 'Read', fields ['date_created']
        db.create_index(u'core_read', ['date_created'])

        # Adding index on 'BaseItem', fields ['date_created']
        db.create_index(u'core_baseitem', ['date_created'])


    def backwards(self, orm):
        # Removing index on 'BaseItem', fields ['date_created']
        db.delete_index(u'core_baseitem', ['date_created'])

        # Removing index on 'Read', fields ['date_created']
        db.delete_index(u'core_read', ['date_created'])


        # Changing field 'Read.date_created'
        db.alter_column(u'core_read', 'date_created', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'fc5ec2e2e5a74b0d98169b8707f15a72'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'08d0df5bf7f9400d8c9bed5b664c56d3'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'331f6eef3c0b48f9aeded5db04d77c2d'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bb3ddff90f9443c28f8455c6d117999b'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
