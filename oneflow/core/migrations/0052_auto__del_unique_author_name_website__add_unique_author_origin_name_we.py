...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Author', fields ['origin_name', 'website']
        db.create_unique(u'core_author', ['origin_name', 'website_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Author', fields ['origin_name', 'website']
        db.delete_unique(u'core_author', ['origin_name', 'website_id'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '7d194f2d76634240bc00926e24899072'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
