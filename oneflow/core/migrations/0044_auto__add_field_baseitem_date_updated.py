...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseItem.date_updated'
        db.add_column(u'core_baseitem', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 10, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseItem.date_updated'
        db.delete_column(u'core_baseitem', 'date_updated')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '3e9b33e874784c0daa6b2d814cb0cdd3'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
