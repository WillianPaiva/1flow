...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Language', fields ['iso639_3']
        db.delete_unique(u'core_language', ['iso639_3'])

        # Removing unique constraint on 'Language', fields ['iso639_1']
        db.delete_unique(u'core_language', ['iso639_1'])

        # Removing unique constraint on 'Language', fields ['iso639_2']
        db.delete_unique(u'core_language', ['iso639_2'])


    def backwards(self, orm):
        # Adding unique constraint on 'Language', fields ['iso639_2']
        db.create_unique(u'core_language', ['iso639_2'])

        # Adding unique constraint on 'Language', fields ['iso639_1']
        db.create_unique(u'core_language', ['iso639_1'])

        # Adding unique constraint on 'Language', fields ['iso639_3']
        db.create_unique(u'core_language', ['iso639_3'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'e7d8b668140b408691d98e47f726d87d'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'41cae1148b3f478c8524618a8efd43bc'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'b90a15345fee48868d1d63695588310d'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f8164999a4f74629b8712212abadaabb'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
