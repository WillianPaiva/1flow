...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_mailfeedrule', 'header_field',
                      self.gf('django.db.models.fields.IntegerField')(default=4, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '3cf65608f46346789640684443cdbe02'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'a70517e244a04fdabf3bf88313c011ea'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'9c245beef8334666a6d28ee1a3188b15'", 'max_length': '32', 'blank': 'True'}),
