...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailFeedRule.finish_action'
        db.add_column(u'core_mailfeedrule', 'finish_action',
    ...
    def backwards(self, orm):
        # Deleting field 'MailFeedRule.finish_action'
        db.delete_column(u'core_mailfeedrule', 'finish_action')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'e6c286dcf5984be9826f58837489e96d'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.mailfeed': {
            ...
            'finish_action': ('django.db.models.fields.CharField', [], {'default': "u'store'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
