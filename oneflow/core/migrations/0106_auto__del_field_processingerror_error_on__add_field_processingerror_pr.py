...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProcessingError.error_on'
        db.delete_column(u'core_processingerror', 'error_on_id')

        # Adding field 'ProcessingError.processor'
        db.add_column(u'core_processingerror', 'processor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='processors', to=orm['core.ChainedProcessor']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProcessingError.error_on'
        raise RuntimeError("Cannot reverse this migration. 'ProcessingError.error_on' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ProcessingError.error_on'
        db.add_column(u'core_processingerror', 'error_on',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='processors', to=orm['core.ChainedProcessor']),
                      keep_default=False)

        # Deleting field 'ProcessingError.processor'
        db.delete_column(u'core_processingerror', 'processor_id')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '084e15349d134527a2065f733ee148dc'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'7f8bf86f974b457f92e86504d33c8554'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'b95b7b357cb141d9a0ffe7ec993600c9'", 'max_length': '32', 'blank': 'True'}),
