...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterAccount.fetch_owned_lists'
        db.add_column(u'core_twitteraccount', 'fetch_owned_lists',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TwitterAccount.fetch_subscribed_lists'
        db.add_column(u'core_twitteraccount', 'fetch_subscribed_lists',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterAccount.fetch_owned_lists'
        db.delete_column(u'core_twitteraccount', 'fetch_owned_lists')

        # Deleting field 'TwitterAccount.fetch_subscribed_lists'
        db.delete_column(u'core_twitteraccount', 'fetch_subscribed_lists')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'a8e34b13ce8a4bc88220e7c982ccd12d'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'589016117ab7400b80d0b02869f9fd27'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'0291da5640fc4faba614d8f0cb4ccd6f'", 'max_length': '32', 'blank': 'True'}),
