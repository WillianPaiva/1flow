...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'BaseItem.date_published_transient'
        db.rename_column(u'core_baseitem', 'date_published_transient', 'date_published')

        # Deleting field 'Article.date_published'
        db.delete_column(u'core_article', 'date_published')

    def backwards(self, orm):
        # Adding field 'BaseItem.date_published_transient'
        db.rename_column(u'core_baseitem', 'date_published', 'date_published_transient')

        # Adding field 'Article.date_published'
        db.add_column(u'core_article', 'date_published',
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '153b5d499eef4ff59b7f5d62c030e7b6'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'5da63b679c794546ade0f562caebdf10'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'1f15f64b51f84a6b969ea89333fabddc'", 'max_length': '32', 'blank': 'True'}),
