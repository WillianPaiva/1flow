...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Read', fields ['is_bookmarked']
        db.create_index(u'core_read', ['is_bookmarked'])

        # Adding index on 'Read', fields ['is_starred']
        db.create_index(u'core_read', ['is_starred'])

        # Adding index on 'Read', fields ['is_read']
        db.create_index(u'core_read', ['is_read'])

        # Adding index on 'Read', fields ['is_good']
        db.create_index(u'core_read', ['is_good'])


    def backwards(self, orm):
        # Removing index on 'Read', fields ['is_good']
        db.delete_index(u'core_read', ['is_good'])

        # Removing index on 'Read', fields ['is_read']
        db.delete_index(u'core_read', ['is_read'])

        # Removing index on 'Read', fields ['is_starred']
        db.delete_index(u'core_read', ['is_starred'])

        # Removing index on 'Read', fields ['is_bookmarked']
        db.delete_index(u'core_read', ['is_bookmarked'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '70a9611c872e41af8b7f90080335fd7a'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'b9c0a7e63d3444b0a11db38a87e2009a'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'12b31ac92c4e485c8ab5d5f6a6dba487'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e37f6828c1274d8eae3b7f7e2d8daaa0'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
