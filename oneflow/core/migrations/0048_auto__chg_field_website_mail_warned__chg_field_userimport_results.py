...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebSite.mail_warned'
        db.alter_column(u'core_website', 'mail_warned', self.gf('json_field.fields.JSONField')())

        # Changing field 'UserImport.results'
        db.alter_column(u'core_userimport', 'results', self.gf('json_field.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'WebSite.mail_warned'
        db.alter_column(u'core_website', 'mail_warned', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'UserImport.results'
        db.alter_column(u'core_userimport', 'results', self.gf('jsonfield.fields.JSONField')(null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'f4626173bd5140db89363bf053d52f2e'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
