...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_author', 'name', self.gf('django.db.models.fields.CharField')(max_length=7168, null=True))

        # Changing field 'Author.origin_name'
        db.alter_column(u'core_author', 'origin_name', self.gf('django.db.models.fields.CharField')(max_length=7168))

    def backwards(self, orm):

        # Changing field 'Author.name'
        db.alter_column(u'core_author', 'name', self.gf('django.db.models.fields.CharField')(max_length=640, null=True))

        # Changing field 'Author.origin_name'
        db.alter_column(u'core_author', 'origin_name', self.gf('django.db.models.fields.CharField')(max_length=640))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '04f9d8372dac44a9919c8c6da2677dbf'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'3fc5ad635dff4ae8bdbfa8d75976dabd'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'a673e5a352d1492aafd5f976faa6fa33'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0bcb25957fd54a209296b592d7be92b9'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
