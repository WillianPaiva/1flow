...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_article', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True))

        # Changing field 'HistoricalArticle.image_url'
        db.alter_column(u'core_historicalarticle', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True))

    def backwards(self, orm):

        # Changing field 'Article.image_url'
        db.alter_column(u'core_article', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'HistoricalArticle.image_url'
        db.alter_column(u'core_historicalarticle', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '23a4147bb2c149ab930e3ed28424a59a'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'76a7cbda5781485baf9c19808da136d6'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'4939f22b32584162af62ec2927bd7308'", 'max_length': '32', 'blank': 'True'}),
