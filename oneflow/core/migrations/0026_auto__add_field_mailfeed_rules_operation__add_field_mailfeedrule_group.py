...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailFeedRule.group'
        db.add_column(u'core_mailfeedrule', 'group',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MailFeedRule.group'
        db.delete_column(u'core_mailfeedrule', 'group')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '5ac7ba46127c4a1daf6b0a09a1d590f6'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
