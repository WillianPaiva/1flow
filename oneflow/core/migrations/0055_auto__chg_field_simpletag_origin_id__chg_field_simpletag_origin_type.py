...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SimpleTag.origin_id'
        db.alter_column(u'core_simpletag', 'origin_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SimpleTag.origin_type'
        db.alter_column(u'core_simpletag', 'origin_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SimpleTag.origin_id'
        raise RuntimeError("Cannot reverse this migration. 'SimpleTag.origin_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SimpleTag.origin_id'
        db.alter_column(u'core_simpletag', 'origin_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'SimpleTag.origin_type'
        raise RuntimeError("Cannot reverse this migration. 'SimpleTag.origin_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SimpleTag.origin_type'
        db.alter_column(u'core_simpletag', 'origin_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '2b92bb723d984bee85487ea2da331dd5'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
