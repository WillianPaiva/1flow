...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseFeed.errors'
        db.alter_column(u'core_basefeed', 'errors', self.gf('json_field.fields.JSONField')())

        # Changing field 'BaseFeed.options'
        db.alter_column(u'core_basefeed', 'options', self.gf('json_field.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'BaseFeed.errors'
        db.alter_column(u'core_basefeed', 'errors', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'BaseFeed.options'
        db.alter_column(u'core_basefeed', 'options', self.gf('jsonfield.fields.JSONField')())
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '4f9cb228bfcc4f138596e6e08c4f8749'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
