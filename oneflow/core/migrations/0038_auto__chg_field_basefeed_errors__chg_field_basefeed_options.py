...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BaseFeed.errors'
        db.alter_column(u'core_basefeed', 'errors', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'BaseFeed.options'
        db.alter_column(u'core_basefeed', 'options', self.gf('jsonfield.fields.JSONField')(null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'fd3747e6b79d4347acfa3d334b654ece'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.basefeed': {
            ...
            'errors': ('jsonfield.fields.JSONField', [], {'default': "u'[]'", 'blank': 'True'}),
            ...
            'options': ('jsonfield.fields.JSONField', [], {'default': "u'{}'", 'blank': 'True'}),
