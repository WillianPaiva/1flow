...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailFeed.account'
        db.add_column(u'core_mailfeed', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.MailAccount'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MailFeed.mailbox'
        db.add_column(u'core_mailfeed', 'mailbox',
                      self.gf('django.db.models.fields.CharField')(default=u'INBOX', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MailFeed.recurse_mailbox'
        db.add_column(u'core_mailfeed', 'recurse_mailbox',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'MailFeedRule.account'
        db.delete_column(u'core_mailfeedrule', 'account_id')

        # Deleting field 'MailFeedRule.mailbox'
        db.delete_column(u'core_mailfeedrule', 'mailbox')

        # Deleting field 'MailFeedRule.recurse_mailbox'
        db.delete_column(u'core_mailfeedrule', 'recurse_mailbox')


    def backwards(self, orm):
        # Deleting field 'MailFeed.account'
        db.delete_column(u'core_mailfeed', 'account_id')

        # Deleting field 'MailFeed.mailbox'
        db.delete_column(u'core_mailfeed', 'mailbox')

        # Deleting field 'MailFeed.recurse_mailbox'
        db.delete_column(u'core_mailfeed', 'recurse_mailbox')

        # Adding field 'MailFeedRule.account'
        db.add_column(u'core_mailfeedrule', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.MailAccount'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MailFeedRule.mailbox'
        db.add_column(u'core_mailfeedrule', 'mailbox',
                      self.gf('django.db.models.fields.CharField')(default=u'INBOX', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MailFeedRule.recurse_mailbox'
        db.add_column(u'core_mailfeedrule', 'recurse_mailbox',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'c6ac9dfa7a884c929452af2f35e67cad'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
