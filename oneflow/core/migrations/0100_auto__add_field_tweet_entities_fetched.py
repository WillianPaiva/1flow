...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.entities_fetched'
        db.add_column(u'core_tweet', 'entities_fetched',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field entities on 'Tweet'
        m2m_table_name = db.shorten_name(u'core_tweet_entities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tweet', models.ForeignKey(orm['core.tweet'], null=False)),
            ('baseitem', models.ForeignKey(orm['core.baseitem'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tweet_id', 'baseitem_id'])

        # Adding M2M table for field mentions on 'Tweet'
        m2m_table_name = db.shorten_name(u'core_tweet_mentions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tweet', models.ForeignKey(orm['core.tweet'], null=False)),
            ('author', models.ForeignKey(orm['core.author'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tweet_id', 'author_id'])


    def backwards(self, orm):
        # Deleting field 'Tweet.entities_fetched'
        db.delete_column(u'core_tweet', 'entities_fetched')

        # Removing M2M table for field entities on 'Tweet'
        db.delete_table(db.shorten_name(u'core_tweet_entities'))

        # Removing M2M table for field mentions on 'Tweet'
        db.delete_table(db.shorten_name(u'core_tweet_mentions'))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '41b928bd21bc427d9a4347f93dcfd2a6'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'16f2901db8be4706aab46f19531caac2'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'3788cb626b8d4b0482233dcc74364d17'", 'max_length': '32', 'blank': 'True'}),
