...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StaffPreferences.allow_all_articles'
        db.delete_column(u'core_staffpreferences', 'allow_all_articles')


    def backwards(self, orm):
        # Adding field 'StaffPreferences.allow_all_articles'
        db.add_column(u'core_staffpreferences', 'allow_all_articles',
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '74e12f80eaed4cb8903af05c97952be1'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'79e1e365c736404e95b3ef80420591f7'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'5c94c0818da74f4daf306a838c03fe7b'", 'max_length': '32', 'blank': 'True'}),
