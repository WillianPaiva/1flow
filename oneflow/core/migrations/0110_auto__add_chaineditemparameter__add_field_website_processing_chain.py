...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChainedItemParameter'
        db.create_table(u'core_chaineditemparameter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ChainedItem'])),
        ...
        db.send_create_signal('core', ['ChainedItemParameter'])

        # Adding field 'WebSite.processing_chain'
        db.add_column(u'core_website', 'processing_chain',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='websites', null=True, to=orm['core.ProcessingChain']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ChainedItemParameter'
        db.delete_table(u'core_chaineditemparameter')

        # Deleting field 'WebSite.processing_chain'
        db.delete_column(u'core_website', 'processing_chain_id')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '0c820f0a02c54f54b7c0e560e57c5f09'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'02e11791a8e443efa73e81e33c805e29'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'62df2001f9ce430b8df208f607d3b665'", 'max_length': '32', 'blank': 'True'}),
