...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MailFeed.finish_action'
        db.delete_column(u'core_mailfeed', 'finish_action')

        # Deleting field 'MailFeed.rules_operation'
        db.delete_column(u'core_mailfeed', 'rules_operation')

        # Deleting field 'MailFeed.match_action'
        db.delete_column(u'core_mailfeed', 'match_action')

        # Deleting field 'MailFeedRule.group_operation'
        db.delete_column(u'core_mailfeedrule', 'group_operation')
        ...
        # Changing field 'MailFeedRule.match_value'
        db.alter_column(u'core_mailfeedrule', 'match_value', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'MailFeedRule.check_error'
        db.alter_column(u'core_mailfeedrule', 'check_error', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'MailFeed.finish_action'
        db.add_column(u'core_mailfeed', 'finish_action',
                      self.gf('django.db.models.fields.CharField')(default=u'markread', max_length=10),
                      keep_default=False)

        # Adding field 'MailFeed.rules_operation'
        db.add_column(u'core_mailfeed', 'rules_operation',
                      self.gf('django.db.models.fields.CharField')(default=u'any', max_length=10),
                      keep_default=False)

        # Adding field 'MailFeed.match_action'
        db.add_column(u'core_mailfeed', 'match_action',
                      self.gf('django.db.models.fields.CharField')(default=u'scrape', max_length=10),
                      keep_default=False)

        # Adding field 'MailFeedRule.group_operation'
        db.add_column(u'core_mailfeedrule', 'group_operation',
                      self.gf('django.db.models.fields.CharField')(default=u'any', max_length=10, null=True, blank=True),
                      keep_default=False)
        ...
        # Changing field 'MailFeedRule.match_value'
        db.alter_column(u'core_mailfeedrule', 'match_value', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'MailFeedRule.check_error'
        db.alter_column(u'core_mailfeedrule', 'check_error', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'a3d5c35e79184c19a078783d0361bac6'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'ae921bfbb2f745d687cb777f5b91b503'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'19eacd884a3443398897b2463f44fd4c'", 'max_length': '32', 'blank': 'True'}),
