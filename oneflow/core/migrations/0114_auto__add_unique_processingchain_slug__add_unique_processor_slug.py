...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProcessingChain', fields ['slug']
        db.create_unique(u'core_processingchain', ['slug'])

        # Adding unique constraint on 'Processor', fields ['slug']
        db.create_unique(u'core_processor', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Processor', fields ['slug']
        db.delete_unique(u'core_processor', ['slug'])

        # Removing unique constraint on 'ProcessingChain', fields ['slug']
        db.delete_unique(u'core_processingchain', ['slug'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'e9ac0ab00b4c45b784d4e9b71dcee69a'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'cad318bce16a46bfaa2aa6790fd80634'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'433b026525064ebc86b701f4df9df9e7'", 'max_length': '32', 'blank': 'True'}),
