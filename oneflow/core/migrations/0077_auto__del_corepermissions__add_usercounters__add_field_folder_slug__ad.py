...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyncNode.user'
        db.add_column(u'core_syncnode', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyncNode.user'
        db.delete_column(u'core_syncnode', 'user_id')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '99d2ce23359944f298a7d92623e56a4e'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'df88ce8d834b4ca0ab4ae30f95cd1492'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'1c5ae9b58cea4169822a03fab209e49a'", 'max_length': '32', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b74b396e2c2047f4931d314e97bc891d'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.usercounters': {
