...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_baseaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_core.baseaccount_set', null=True, to=orm['contenttypes.ContentType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accounts', to=orm['base.User'])),
            ...
            ('date_last_conn', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('conn_error', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('is_usable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('image_url', self.gf('django.db.models.fields.URLField')(max_length=384, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['BaseAccount'])

        # Deleting field 'MailAccount.user'
        db.delete_column(u'core_mailaccount', 'user_id')
        ...
        # Deleting field 'MailAccount.name'
        db.delete_column(u'core_mailaccount', 'name')

        # Deleting field 'MailAccount.id'
        db.delete_column(u'core_mailaccount', u'id')

        # Deleting field 'MailAccount.date_created'
        db.delete_column(u'core_mailaccount', 'date_created')

        # Adding field 'MailAccount.baseaccount_ptr'
        db.add_column(u'core_mailaccount', u'baseaccount_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['core.BaseAccount'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BaseAccount'
        db.delete_table(u'core_baseaccount')


        # User chose to not deal with backwards NULL issues for 'MailAccount.user'
        raise RuntimeError("Cannot reverse this migration. 'MailAccount.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MailAccount.user'
        db.add_column(u'core_mailaccount', 'user',
        ...
        # Adding field 'MailAccount.name'
        db.add_column(u'core_mailaccount', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'MailAccount.id'
        raise RuntimeError("Cannot reverse this migration. 'MailAccount.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MailAccount.id'
        db.add_column(u'core_mailaccount', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'MailAccount.date_created'
        raise RuntimeError("Cannot reverse this migration. 'MailAccount.date_created' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MailAccount.date_created'
        db.add_column(u'core_mailaccount', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)

        # Deleting field 'MailAccount.baseaccount_ptr'
        db.delete_column(u'core_mailaccount', u'baseaccount_ptr_id')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '2269c28be66749ddb8d3215692d57009'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'596299df7ddc4cedb124d5843fbafb17'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'a930bdc81e1b4741b2ca5e79e925ffe4'", 'max_length': '32', 'blank': 'True'}),
