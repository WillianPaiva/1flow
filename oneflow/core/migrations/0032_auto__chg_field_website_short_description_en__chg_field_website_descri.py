...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebSite.short_description_en'
        db.alter_column(u'core_website', 'short_description_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'WebSite.description_en'
        db.alter_column(u'core_website', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'WebSite.thumbnail_url'
        db.alter_column(u'core_website', 'thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WebSite.short_description_en'
        raise RuntimeError("Cannot reverse this migration. 'WebSite.short_description_en' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WebSite.short_description_en'
        db.alter_column(u'core_website', 'short_description_en', self.gf('django.db.models.fields.CharField')(max_length=256))

        # User chose to not deal with backwards NULL issues for 'WebSite.description_en'
        raise RuntimeError("Cannot reverse this migration. 'WebSite.description_en' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WebSite.description_en'
        db.alter_column(u'core_website', 'description_en', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'WebSite.thumbnail_url'
        raise RuntimeError("Cannot reverse this migration. 'WebSite.thumbnail_url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WebSite.thumbnail_url'
        db.alter_column(u'core_website', 'thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'af4e5e84fff54f1e9979b6e70afe1d45'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
