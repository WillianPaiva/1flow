...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterAccount.timeline'
        db.add_column(u'core_twitteraccount', 'timeline',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='twitter_account', unique=True, null=True, to=orm['core.TwitterFeed']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterAccount.timeline'
        db.delete_column(u'core_twitteraccount', 'timeline_id')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '3f2b93f79e4343a3bf45afd714260f77'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'e219e6ee6d54496a9c94e92f4070e753'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'133860ad974e441b850a7449cd82c462'", 'max_length': '32', 'blank': 'True'}),
