...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseAccount.options'
        db.delete_column(u'core_baseaccount', 'options')


    def backwards(self, orm):
        # Adding field 'BaseAccount.options'
        db.add_column(u'core_baseaccount', 'options',
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '209e6822927f40428b721962300425dd'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'edd4f27e0dcc48ab939bb7a5b12c63b4'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'422a7d3f1dc64e4d911f1676524a2770'", 'max_length': '32', 'blank': 'True'}),
