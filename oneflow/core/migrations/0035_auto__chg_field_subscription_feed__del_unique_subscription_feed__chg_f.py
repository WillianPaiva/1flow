...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Read', fields ['item']
        db.delete_unique(u'core_read', ['item_id'])

        # Removing unique constraint on 'Read', fields ['user']
        db.delete_unique(u'core_read', ['user_id'])

        # Removing unique constraint on 'Subscription', fields ['user']
        db.delete_unique(u'core_subscription', ['user_id'])

        # Removing unique constraint on 'Subscription', fields ['feed']
        db.delete_unique(u'core_subscription', ['feed_id'])


        # Changing field 'Subscription.feed'
        db.alter_column(u'core_subscription', 'feed_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseFeed']))

        # Changing field 'Subscription.user'
        db.alter_column(u'core_subscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.User']))

        # Changing field 'Read.user'
        db.alter_column(u'core_read', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.User']))

        # Changing field 'Read.item'
        db.alter_column(u'core_read', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BaseItem']))

    def backwards(self, orm):

        # Changing field 'Subscription.feed'
        db.alter_column(u'core_subscription', 'feed_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.BaseFeed'], unique=True))
        # Adding unique constraint on 'Subscription', fields ['feed']
        db.create_unique(u'core_subscription', ['feed_id'])


        # Changing field 'Subscription.user'
        db.alter_column(u'core_subscription', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['base.User'], unique=True))
        # Adding unique constraint on 'Subscription', fields ['user']
        db.create_unique(u'core_subscription', ['user_id'])


        # Changing field 'Read.user'
        db.alter_column(u'core_read', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['base.User'], unique=True))
        # Adding unique constraint on 'Read', fields ['user']
        db.create_unique(u'core_read', ['user_id'])


        # Changing field 'Read.item'
        db.alter_column(u'core_read', 'item_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.BaseItem'], unique=True))
        # Adding unique constraint on 'Read', fields ['item']
        db.create_unique(u'core_read', ['item_id'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '53c9eb265a704bbdbdd8e6339b8c2525'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
