...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_twitterfeed', (
            (u'basefeed_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.BaseFeed'], unique=True, primary_key=True)),
            ('is_timeline', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('backfill', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('match_action', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('finish_action', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('rules_operation', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('scrape_whitelist', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('scrape_blacklist', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('core', ['TwitterFeed'])

        # Adding M2M table for field account on 'TwitterFeed'
        m2m_table_name = db.shorten_name(u'core_twitterfeed_account')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('twitterfeed', models.ForeignKey(orm['core.twitterfeed'], null=False)),
            ('twitteraccount', models.ForeignKey(orm['core.twitteraccount'], null=False))
        ))
        db.create_unique(m2m_table_name, ['twitterfeed_id', 'twitteraccount_id'])

        # Adding model 'TwitterFeedRule'
        db.create_table(u'core_twitterfeedrule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('twitterfeed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rules', to=orm['core.TwitterFeed'])),
            ('group', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('group_operation', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ('match_field', self.gf('django.db.models.fields.IntegerField')(default=10, blank=True)),
            ('match_type', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ('match_case', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('match_value', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('other_field', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('clone_of', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TwitterFeedRule'], null=True, blank=True)),
        ...
        db.send_create_signal('core', ['TwitterFeedRule'])


    def backwards(self, orm):
        # Deleting model 'TwitterFeed'
        db.delete_table(u'core_twitterfeed')

        # Removing M2M table for field account on 'TwitterFeed'
        db.delete_table(db.shorten_name(u'core_twitterfeed_account'))

        # Deleting model 'TwitterFeedRule'
        db.delete_table(u'core_twitterfeedrule')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '2521d130aeae4c46881215ebbcdee9bd'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'7a0cb0d62aa249b5843721e12ef4503c'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'ad712291d03844eab4e48f27caffd571'", 'max_length': '32', 'blank': 'True'}),
        ...
        'core.twitterfeed': {
            ...
            'backfill': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'basefeed_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.BaseFeed']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'core.twitterfeedrule': {
            ...
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'match_case': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'match_field': ('django.db.models.fields.IntegerField', [], {'default': '10', 'blank': 'True'}),
            'match_type': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'}),
            'match_value': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
