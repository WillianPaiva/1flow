...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_article', 'url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=512))

    def backwards(self, orm):

        # Changing field 'Article.url'
        db.alter_column(u'core_article', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '6b822d9282ec47eb8d86d395c5576494'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
