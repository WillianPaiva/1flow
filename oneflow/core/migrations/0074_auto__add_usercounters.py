...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserCounters'
        db.create_table(u'core_usercounters', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='user_counters', unique=True, primary_key=True, to=orm['base.User'])),
            ('placeholder', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['UserCounters'])


    def backwards(self, orm):
        # Deleting model 'UserCounters'
        db.delete_table(u'core_usercounters')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '16919506c175432080f3f1b5167f75f4'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'a3e836648cc84c40aa9a6f19b4d9bebd'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'5e9eba7b24b04d74bde51185fd026f49'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2370c7cca90d4f57a8306c8e7b654186'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.usercounters': {
