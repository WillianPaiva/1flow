...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field account on 'MailFeed'
        m2m_table_name = db.shorten_name(u'core_mailfeed_account')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mailfeed', models.ForeignKey(orm['core.mailfeed'], null=False)),
            ('mailaccount', models.ForeignKey(orm['core.mailaccount'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mailfeed_id', 'mailaccount_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field account on 'MailFeed'
        db.delete_table(db.shorten_name(u'core_mailfeed_account'))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '421c357c9f3c47e08d5162170a86a1f5'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
