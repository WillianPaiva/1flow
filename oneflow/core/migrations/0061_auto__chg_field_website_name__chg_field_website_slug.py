...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_website', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'WebSite.slug'
        db.alter_column(u'core_website', 'slug', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'WebSite.name'
        db.alter_column(u'core_website', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'WebSite.slug'
        db.alter_column(u'core_website', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'c69d137a0f974edda1f9dc8ca40aee4c'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'9c9d62d35a8649afadabb5e5ae06b3f1'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'d1917dc949684328b97a0373c8f252e6'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'81d0f8c158ce4b48b3675b025ce2cb0d'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
