...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailFeedRule.match_action'
        db.alter_column(u'core_mailfeedrule', 'match_action', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
        ...
        # Adding field 'MailFeed.scrape_whitelist'
        db.add_column(u'core_mailfeed', 'scrape_whitelist',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MailFeed.scrape_blacklist'
        db.add_column(u'core_mailfeed', 'scrape_blacklist',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MailFeedRule.match_action'
        db.alter_column(u'core_mailfeedrule', 'match_action', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Deleting field 'MailFeed.match_action'
        db.delete_column(u'core_mailfeed', 'match_action')

        # Deleting field 'MailFeed.scrape_whitelist'
        db.delete_column(u'core_mailfeed', 'scrape_whitelist')

        # Deleting field 'MailFeed.scrape_blacklist'
        db.delete_column(u'core_mailfeed', 'scrape_blacklist')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '48e7e9131c5c455082a7065429afbe34'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
