...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SyncNode', fields ['uuid']
        db.delete_unique(u'core_syncnode', ['uuid'])


        # Changing field 'SyncNode.uuid'
        db.alter_column(u'core_syncnode', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
        # Adding index on 'SyncNode', fields ['uuid']
        db.create_index(u'core_syncnode', ['uuid'])


    def backwards(self, orm):
        # Removing index on 'SyncNode', fields ['uuid']
        db.delete_index(u'core_syncnode', ['uuid'])


        # Changing field 'SyncNode.uuid'
        db.alter_column(u'core_syncnode', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))
        # Adding unique constraint on 'SyncNode', fields ['uuid']
        db.create_unique(u'core_syncnode', ['uuid'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'dd2c38a7eb8d4610a23583ff075c84a4'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'5166be43eb1f408eb30b085395f94a28'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'154e5324110c4f8d833f84f0a0353e4e'", 'max_length': '32', 'blank': 'True'}),
