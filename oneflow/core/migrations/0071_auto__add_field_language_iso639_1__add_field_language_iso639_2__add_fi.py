...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Language.iso639_1'
        db.add_column(u'core_language', 'iso639_1',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.iso639_2'
        db.add_column(u'core_language', 'iso639_2',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.iso639_3'
        db.add_column(u'core_language', 'iso639_3',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Language.iso639_1'
        db.delete_column(u'core_language', 'iso639_1')

        # Deleting field 'Language.iso639_2'
        db.delete_column(u'core_language', 'iso639_2')

        # Deleting field 'Language.iso639_3'
        db.delete_column(u'core_language', 'iso639_3')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '81d9f6a5cd864c15b978aa702514d794'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.language': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iso639_1': ('django.db.models.fields.CharField', [], {'max_length': '16', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'iso639_2': ('django.db.models.fields.CharField', [], {'max_length': '16', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'iso639_3': ('django.db.models.fields.CharField', [], {'max_length': '16', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'74026eb2d9c14917a6aed7eea7d63212'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'bf38ef07767846dc91e777a01ca60c56'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'48afb31f609f47d8a2e40f9b36b21abd'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
