...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailFeed.user'
        db.add_column(u'core_mailfeed', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['base.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '49b0c7efc41041bbaac6f4835787b1ed'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
