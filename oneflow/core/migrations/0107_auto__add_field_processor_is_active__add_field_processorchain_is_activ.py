...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Processor.is_active'
        db.add_column(u'core_processor', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProcessorChain.is_active'
        db.add_column(u'core_processorchain', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Processor.is_active'
        db.delete_column(u'core_processor', 'is_active')

        # Deleting field 'ProcessorChain.is_active'
        db.delete_column(u'core_processorchain', 'is_active')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '8fd580acd8184354b56b8c79b5f78e22'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'ebffdb5bfcdd4fd5bf4ac552eae016e8'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'c055c4b2e44a410d9ac7732253a10a7d'", 'max_length': '32', 'blank': 'True'}),
