...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_author', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.origin_id'
        db.add_column(u'core_author', 'origin_id',
                      self.gf('django.db.models.fields.BigIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.origin_id_str'
        db.add_column(u'core_author', 'origin_id_str',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.website_data'
        db.add_column(u'core_author', 'website_data',
                      self.gf('json_field.fields.JSONField')(default={}, blank=True),
                      keep_default=False)

        # Adding M2M table for field identities on 'Author'
        m2m_table_name = db.shorten_name(u'core_author_identities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_author', models.ForeignKey(orm['core.author'], null=False)),
            ('to_author', models.ForeignKey(orm['core.author'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_author_id', 'to_author_id'])


    def backwards(self, orm):
        # Deleting field 'Author.username'
        db.delete_column(u'core_author', 'username')

        # Deleting field 'Author.origin_id'
        db.delete_column(u'core_author', 'origin_id')

        # Deleting field 'Author.origin_id_str'
        db.delete_column(u'core_author', 'origin_id_str')

        # Deleting field 'Author.website_data'
        db.delete_column(u'core_author', 'website_data')

        # Removing M2M table for field identities on 'Author'
        db.delete_table(db.shorten_name(u'core_author_identities'))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'dc942cd903574155a0708522ed5ef33b'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'d190daacf668427b9aae80c123c05835'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'b38d4647a3044ebea4f9f7f9674c400b'", 'max_length': '32', 'blank': 'True'}),
