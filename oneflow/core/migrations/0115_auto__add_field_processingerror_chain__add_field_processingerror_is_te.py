...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessingError.chain'
        db.add_column(u'core_processingerror', 'chain',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='errors', null=True, to=orm['core.ProcessingChain']),
                      keep_default=False)

        # Adding field 'ProcessingError.is_temporary'
        db.add_column(u'core_processingerror', 'is_temporary',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'ProcessingError.processor'
        db.alter_column(u'core_processingerror', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.ChainedItem']))

    def backwards(self, orm):
        # Deleting field 'ProcessingError.chain'
        db.delete_column(u'core_processingerror', 'chain_id')

        # Deleting field 'ProcessingError.is_temporary'
        db.delete_column(u'core_processingerror', 'is_temporary')


        # User chose to not deal with backwards NULL issues for 'ProcessingError.processor'
        raise RuntimeError("Cannot reverse this migration. 'ProcessingError.processor' and its values cannot be restored.")
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '1a965046dc644cedaa8216822e70e026'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'9a13f1f2a2ee4157b6a7f03c16cba5df'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'285e4b0aa0374d29bd5e935b15575db6'", 'max_length': '32', 'blank': 'True'}),
