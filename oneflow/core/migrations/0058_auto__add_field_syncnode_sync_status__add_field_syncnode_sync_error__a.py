...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyncNode.sync_status'
        db.add_column(u'core_syncnode', 'sync_status',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True),
                      keep_default=False)

        # Adding field 'SyncNode.sync_error'
        db.add_column(u'core_syncnode', 'sync_error',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SyncNode.strategy'
        db.add_column(u'core_syncnode', 'strategy',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyncNode.sync_status'
        db.delete_column(u'core_syncnode', 'sync_status')

        # Deleting field 'SyncNode.sync_error'
        db.delete_column(u'core_syncnode', 'sync_error')

        # Deleting field 'SyncNode.strategy'
        db.delete_column(u'core_syncnode', 'strategy')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '9b4f904ad80b46de9c34222765b78c2b'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'b436c0bd76524c1ab504624af934fb64'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'a370db42e1554c8382e4f583fe12556d'", 'max_length': '32', 'blank': 'True'}),
            ...
            'sync_status': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'blank': 'True'}),
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '384', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'23bc36eda6df4436ac7e6b005b248e0a'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
