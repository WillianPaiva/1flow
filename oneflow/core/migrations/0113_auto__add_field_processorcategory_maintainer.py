...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_processorcategory', 'maintainer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='maintained_categories', null=True, to=orm['base.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessorCategory.maintainer'
        db.delete_column(u'core_processorcategory', 'maintainer_id')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '32be8a76e6ad413d98f411bb57d62a97'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'17f0ed3673b14e4797e50da9c6c2edf6'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'150a21e473ca4a40b4cd9009a9751507'", 'max_length': '32', 'blank': 'True'}),
