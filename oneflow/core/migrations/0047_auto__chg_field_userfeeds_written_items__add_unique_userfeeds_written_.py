...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseFeed.name'
        db.alter_column(u'core_basefeed', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BaseFeed.name'
        raise RuntimeError("Cannot reverse this migration. 'BaseFeed.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BaseFeed.name'
        db.alter_column(u'core_basefeed', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '70055e3b3b7842e1acbfabf5ad5cd3f2'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
