...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_tweet', (
            ...
            ('tweet_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, unique=True, blank=True)),
        ))
        db.send_create_signal('core', ['Tweet'])

        # Adding field 'OriginalData.twitter'
        db.add_column(u'core_originaldata', 'twitter',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OriginalData.twitter_processed'
        db.add_column(u'core_originaldata', 'twitter_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'OriginalData.raw_email'
        db.alter_column(u'core_originaldata', 'raw_email', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OriginalData.google_reader'
        db.alter_column(u'core_originaldata', 'google_reader', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OriginalData.feedparser'
        db.alter_column(u'core_originaldata', 'feedparser', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Tweet'
        db.delete_table(u'core_tweet')

        # Deleting field 'OriginalData.twitter'
        db.delete_column(u'core_originaldata', 'twitter')

        # Deleting field 'OriginalData.twitter_processed'
        db.delete_column(u'core_originaldata', 'twitter_processed')


        # User chose to not deal with backwards NULL issues for 'OriginalData.raw_email'
        raise RuntimeError("Cannot reverse this migration. 'OriginalData.raw_email' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OriginalData.raw_email'
        db.alter_column(u'core_originaldata', 'raw_email', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'OriginalData.google_reader'
        raise RuntimeError("Cannot reverse this migration. 'OriginalData.google_reader' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OriginalData.google_reader'
        db.alter_column(u'core_originaldata', 'google_reader', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'OriginalData.feedparser'
        raise RuntimeError("Cannot reverse this migration. 'OriginalData.feedparser' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OriginalData.feedparser'
        db.alter_column(u'core_originaldata', 'feedparser', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '972cdb7226ed4645959bd3743da5fd47'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'c5fee3d2d0c1459cb40af570aab71c3c'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'4ae2d571a9af4c84aa49f9db3c20e033'", 'max_length': '32', 'blank': 'True'}),
        ...
        'core.tweet': {
            ...
            u'baseitem_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.BaseItem']", 'unique': 'True', 'primary_key': 'True'}),
            'tweet_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'unique': 'True', 'blank': 'True'})
        },
        'core.twitteraccount': {
