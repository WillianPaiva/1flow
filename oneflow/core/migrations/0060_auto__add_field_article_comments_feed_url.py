...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.comments_feed_url'
        db.add_column(u'core_article', 'comments_feed_url',
                      self.gf('django.db.models.fields.URLField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.comments_feed_url'
        db.delete_column(u'core_article', 'comments_feed_url')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '036119956b1c4297a4e6e073eec7d61e'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'49666a973dda4495b22a7f64aa1bff2e'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'b907af6814864f4692e9efa8a9799486'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fd454d9e938543a6b03e8c700180a501'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
