...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # for tweet in orm.Tweet.objects.exclude(date_published=None):
        #     tweet.date_published_transient = tweet.date_published
        #     tweet.save()
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'af77bf6d9ba442bfb9ff18900b47e1b9'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.baseitem': {
            ...
            'date_published_transient': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'b581b52609ff4e93bfd96c0dd40f7b83'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'e659a0bfe5904a29856205579c3715d0'", 'max_length': '32', 'blank': 'True'}),
