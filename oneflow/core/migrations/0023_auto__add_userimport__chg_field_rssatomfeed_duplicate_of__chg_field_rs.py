...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_userimport', (
            ...
            ('lines', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('messages', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
            ('results', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['UserImport'])

    def backwards(self, orm):
        # Deleting model 'UserImport'
        db.delete_table(u'core_userimport')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '389dbb2a0c314828a5f1ba140fbca691'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.userimport': {
            ...
            'messages': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
