...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailFeedRule.match_case'
        db.add_column(u'core_mailfeedrule', 'match_case',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MailFeedRule.is_valid'
        db.add_column(u'core_mailfeedrule', 'is_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'MailFeedRule.check_error'
        db.add_column(u'core_mailfeedrule', 'check_error',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailFeedRule.match_case'
        db.delete_column(u'core_mailfeedrule', 'match_case')

        # Deleting field 'MailFeedRule.is_valid'
        db.delete_column(u'core_mailfeedrule', 'is_valid')

        # Deleting field 'MailFeedRule.check_error'
        db.delete_column(u'core_mailfeedrule', 'check_error')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '3c207ceba41e4059b16c4377e328929c'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
