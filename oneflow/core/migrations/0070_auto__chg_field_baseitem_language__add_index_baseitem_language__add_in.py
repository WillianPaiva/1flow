...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_baseitem', 'language')

        # Changing field 'BaseItem.language'
    ...
    def backwards(self, orm):
        # Removing index on 'BaseItem', fields ['text_direction']
        db.delete_index(u'core_baseitem', ['text_direction'])

        # Removing index on 'BaseItem', fields ['language']
        db.delete_index(u'core_baseitem', ['language_id'])

        # User chose to not deal with backwards NULL issues for 'BaseItem.language'
        raise RuntimeError("Cannot reverse this migration. 'BaseItem.language' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration
        # Renaming column for 'BaseItem.language' to match new field type.
        db.rename_column(u'core_baseitem', 'language_id', 'language')
        # Changing field 'BaseItem.language'
        db.alter_column(u'core_baseitem', 'language', self.gf('django.db.models.fields.CharField')(max_length=5))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '15a9fc9dd2844775af37af39ae0a2458'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'0c4cf218f9474ae39642b9c6607ae845'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'3c3d2bfdfaa149f796937cce78d621e5'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4741967b15ad4a59922d0dea2b90b1f2'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
