...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcessingError'
        db.create_table(u'core_processingerror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('instance_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('error_on', self.gf('django.db.models.fields.related.ForeignKey')(related_name='processors', to=orm['core.ChainedProcessor'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('issue_ref', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('data', self.gf('json_field.fields.JSONField')(default={}, blank=True)),
        ))
        db.send_create_signal('core', ['ProcessingError'])

        # Adding model 'Processor'
        db.create_table(u'core_processor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('duplicate_of', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Processor'], null=True, blank=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processors', null=True, to=orm['base.User'])),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['core.Processor'])),
            ('input_type', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ...
            ('source_code', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('input_detect_code', self.gf('django.db.models.fields.TextField')(blank=True)),
            (u'lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('core', ['Processor'])
        ...
        db.create_table(u'core_processorchain', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['core.ProcessorChain'])),
            ('short_description_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('short_description_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('short_description_nt', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'ProcessingError'
        db.delete_table(u'core_processingerror')

        # Deleting model 'Processor'
        db.delete_table(u'core_processor')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '073c87b003e745fb8a05e76c663a0b41'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'4c1eedde40814ea7af1d5d9e5a0fe3c6'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.processor': {
            ...
            'duplicate_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_detect_code': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'input_type': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            ...
            'source_code': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'643a262103cf4107a54b8ba3aee6a7a9'", 'max_length': '32', 'blank': 'True'}),
