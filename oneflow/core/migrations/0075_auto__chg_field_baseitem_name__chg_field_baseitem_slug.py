...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseItem.name'
        db.alter_column(u'core_baseitem', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'BaseItem.slug'
        db.alter_column(u'core_baseitem', 'slug', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'BaseItem.name'
        db.alter_column(u'core_baseitem', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'BaseItem.slug'
        db.alter_column(u'core_baseitem', 'slug', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '72f170aa92f8454cb0ac56cb835be1ac'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'be20c0df81ca483296250c74208e9ec6'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'ac8715744ffb4158a72637e0bf7c5a7b'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9e3f1f318b1b4646916ae25ac4a3bbc3'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
