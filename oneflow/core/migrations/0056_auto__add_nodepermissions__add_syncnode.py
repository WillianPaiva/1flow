...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NodePermissions'
        db.create_table(u'core_nodepermissions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SyncNode'], null=True, blank=True)),
            ('permission', self.gf('django.db.models.fields.IntegerField')(default=2, blank=True)),
            ('token', self.gf('django.db.models.fields.CharField')(default='68aca9063c2e423bb41d41f2bda872b5', max_length=32, blank=True)),
        ))
        db.send_create_signal('core', ['NodePermissions'])

        # Adding model 'SyncNode'
        db.create_table(u'core_syncnode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True)),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=384, unique=True, null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='3fe605ba86d64fae897dee40787a662f', unique=True, max_length=32, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('permission', self.gf('django.db.models.fields.IntegerField')(default=2, blank=True)),
            ('local_token', self.gf('django.db.models.fields.CharField')(default='2776b54ecb864a1791716b031f7d005d', max_length=32, blank=True)),
            ('remote_token', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('is_local_instance', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('broadcast', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
        ))
        db.send_create_signal('core', ['SyncNode'])


    def backwards(self, orm):
        # Deleting model 'NodePermissions'
        db.delete_table(u'core_nodepermissions')

        # Deleting model 'SyncNode'
        db.delete_table(u'core_syncnode')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'cff31167c23942e19c9b91322c2e288f'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2ab94a87e07141a48b2edb3d0368ce0a'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'c6b07bd3a570406983c46ea6f2a8c6df'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2cf8f010947448e0afef661d82f89fb3'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
