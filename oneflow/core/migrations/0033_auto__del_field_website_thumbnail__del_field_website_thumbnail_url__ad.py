...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WebSite.thumbnail'
        db.delete_column(u'core_website', 'thumbnail')

        # Deleting field 'WebSite.thumbnail_url'
        db.delete_column(u'core_website', 'thumbnail_url')

        # Adding field 'WebSite.image'
        db.add_column(u'core_website', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebSite.image_url'
        db.add_column(u'core_website', 'image_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WebSite.thumbnail'
        db.add_column(u'core_website', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebSite.thumbnail_url'
        db.add_column(u'core_website', 'thumbnail_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'WebSite.image'
        db.delete_column(u'core_website', 'image')

        # Deleting field 'WebSite.image_url'
        db.delete_column(u'core_website', 'image_url')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '9224e6919a6345289d93fb5d8519265b'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
