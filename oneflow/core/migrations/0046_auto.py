...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field reads on 'Subscription'
        m2m_table_name = db.shorten_name(u'core_subscription_reads')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field reads on 'Subscription'
        db.delete_table(db.shorten_name(u'core_subscription_reads'))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'd5a40ae38e8a4dd68cc6895bc718eef0'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
