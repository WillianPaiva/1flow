...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Processor.input_detect_code'
        db.delete_column(u'core_processor', 'input_detect_code')

        # Deleting field 'Processor.input_type'
        db.delete_column(u'core_processor', 'input_type')

        # Deleting field 'Processor.source_code'
        db.delete_column(u'core_processor', 'source_code')
        ...
        # Adding field 'Processor.source_address'
        db.add_column(u'core_processor', 'source_address',
                      self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Processor.needs_parameters'
        db.add_column(u'core_processor', 'needs_parameters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Processor.requirements'
        db.add_column(u'core_processor', 'requirements',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Processor.accept_code'
        db.add_column(u'core_processor', 'accept_code',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Processor.process_code'
        db.add_column(u'core_processor', 'process_code',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ChainedProcessor.parameters'
        db.add_column(u'core_chainedprocessor', 'parameters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Processor.input_detect_code'
        db.add_column(u'core_processor', 'input_detect_code',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Processor.input_type'
        db.add_column(u'core_processor', 'input_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Processor.source_code'
        db.add_column(u'core_processor', 'source_code',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Processor.source_address'
        db.delete_column(u'core_processor', 'source_address')

        # Deleting field 'Processor.needs_parameters'
        db.delete_column(u'core_processor', 'needs_parameters')

        # Deleting field 'Processor.requirements'
        db.delete_column(u'core_processor', 'requirements')

        # Deleting field 'Processor.accept_code'
        db.delete_column(u'core_processor', 'accept_code')

        # Deleting field 'Processor.process_code'
        db.delete_column(u'core_processor', 'process_code')

        # Deleting field 'ChainedProcessor.parameters'
        db.delete_column(u'core_chainedprocessor', 'parameters')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '262738bd32d9440bba462f33897162bd'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'e761231f3f5c4949aa25388e7b1300cd'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.processingerror': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'error_on': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'processors'", 'to': "orm['core.ChainedProcessor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'f001938c48a14a62ba92adc8eff30609'", 'max_length': '32', 'blank': 'True'}),
