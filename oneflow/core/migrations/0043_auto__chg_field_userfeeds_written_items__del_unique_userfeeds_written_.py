...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserSubscriptions', fields ['sent_items']
        db.delete_unique(u'core_usersubscriptions', ['sent_items_id'])

        # Removing unique constraint on 'UserSubscriptions', fields ['received_items']
        db.delete_unique(u'core_usersubscriptions', ['received_items_id'])

        # Removing unique constraint on 'UserSubscriptions', fields ['imported_items']
        db.delete_unique(u'core_usersubscriptions', ['imported_items_id'])

        # Removing unique constraint on 'UserSubscriptions', fields ['written_items']
        db.delete_unique(u'core_usersubscriptions', ['written_items_id'])

        # Removing unique constraint on 'UserFeeds', fields ['sent_items']
        db.delete_unique(u'core_userfeeds', ['sent_items_id'])

        # Removing unique constraint on 'UserFeeds', fields ['received_items']
        db.delete_unique(u'core_userfeeds', ['received_items_id'])

        # Removing unique constraint on 'UserFeeds', fields ['imported_items']
        db.delete_unique(u'core_userfeeds', ['imported_items_id'])

        # Removing unique constraint on 'UserFeeds', fields ['written_items']
        db.delete_unique(u'core_userfeeds', ['written_items_id'])


        # Changing field 'UserFeeds.written_items'
        db.alter_column(u'core_userfeeds', 'written_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.BaseFeed']))

        # Changing field 'UserFeeds.imported_items'
        db.alter_column(u'core_userfeeds', 'imported_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.BaseFeed']))

        # Changing field 'UserFeeds.received_items'
        db.alter_column(u'core_userfeeds', 'received_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.BaseFeed']))

        # Changing field 'UserFeeds.sent_items'
        db.alter_column(u'core_userfeeds', 'sent_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.BaseFeed']))

        # Changing field 'UserSubscriptions.written_items'
        db.alter_column(u'core_usersubscriptions', 'written_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Subscription']))

        # Changing field 'UserSubscriptions.imported_items'
        db.alter_column(u'core_usersubscriptions', 'imported_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Subscription']))

        # Changing field 'UserSubscriptions.received_items'
        db.alter_column(u'core_usersubscriptions', 'received_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Subscription']))

        # Changing field 'UserSubscriptions.sent_items'
        db.alter_column(u'core_usersubscriptions', 'sent_items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Subscription']))

    def backwards(self, orm):

        # Changing field 'UserFeeds.written_items'
        db.alter_column(u'core_userfeeds', 'written_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.BaseFeed']))
        # Adding unique constraint on 'UserFeeds', fields ['written_items']
        db.create_unique(u'core_userfeeds', ['written_items_id'])


        # Changing field 'UserFeeds.imported_items'
        db.alter_column(u'core_userfeeds', 'imported_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.BaseFeed']))
        # Adding unique constraint on 'UserFeeds', fields ['imported_items']
        db.create_unique(u'core_userfeeds', ['imported_items_id'])


        # Changing field 'UserFeeds.received_items'
        db.alter_column(u'core_userfeeds', 'received_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.BaseFeed']))
        # Adding unique constraint on 'UserFeeds', fields ['received_items']
        db.create_unique(u'core_userfeeds', ['received_items_id'])


        # Changing field 'UserFeeds.sent_items'
        db.alter_column(u'core_userfeeds', 'sent_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.BaseFeed']))
        # Adding unique constraint on 'UserFeeds', fields ['sent_items']
        db.create_unique(u'core_userfeeds', ['sent_items_id'])


        # Changing field 'UserSubscriptions.written_items'
        db.alter_column(u'core_usersubscriptions', 'written_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Subscription']))
        # Adding unique constraint on 'UserSubscriptions', fields ['written_items']
        db.create_unique(u'core_usersubscriptions', ['written_items_id'])


        # Changing field 'UserSubscriptions.imported_items'
        db.alter_column(u'core_usersubscriptions', 'imported_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Subscription']))
        # Adding unique constraint on 'UserSubscriptions', fields ['imported_items']
        db.create_unique(u'core_usersubscriptions', ['imported_items_id'])


        # Changing field 'UserSubscriptions.received_items'
        db.alter_column(u'core_usersubscriptions', 'received_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Subscription']))
        # Adding unique constraint on 'UserSubscriptions', fields ['received_items']
        db.create_unique(u'core_usersubscriptions', ['received_items_id'])


        # Changing field 'UserSubscriptions.sent_items'
        db.alter_column(u'core_usersubscriptions', 'sent_items_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Subscription']))
        # Adding unique constraint on 'UserSubscriptions', fields ['sent_items']
        db.create_unique(u'core_usersubscriptions', ['sent_items_id'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'cabe104751ea42ec806d265b32b0688d'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.subscription': {
            ...
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions'", 'to': "orm['core.BaseFeed']"}),
            ...
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'thumbnail_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'all_subscriptions'", 'to': u"orm['base.User']"})
        },
        'core.userfeeds': {
            ...
            'imported_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'imported_items'", 'null': 'True', 'to': "orm['core.BaseFeed']"}),
            'received_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'received_items'", 'null': 'True', 'to': "orm['core.BaseFeed']"}),
            'sent_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sent_items'", 'null': 'True', 'to': "orm['core.BaseFeed']"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'feeds'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['base.User']"}),
            'written_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'written_items'", 'null': 'True', 'to': "orm['core.BaseFeed']"})
        },
        'core.userimport': {
        ...
        'core.usersubscriptions': {
            ...
            'imported_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'imported_items'", 'null': 'True', 'to': "orm['core.Subscription']"}),
            'received_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'received_items'", 'null': 'True', 'to': "orm['core.Subscription']"}),
            'sent_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sent_items'", 'null': 'True', 'to': "orm['core.Subscription']"}),
            ...
            'written_items': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'written_items'", 'null': 'True', 'to': "orm['core.Subscription']"})
        },
        'core.website': {
