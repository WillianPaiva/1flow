...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseItem.date_added'
        db.delete_column(u'core_baseitem', 'date_added')

        # Adding field 'BaseItem.date_created'
        db.add_column(u'core_baseitem', 'date_created',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BaseItem.date_added'
        raise RuntimeError("Cannot reverse this migration. 'BaseItem.date_added' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BaseItem.date_added'
        db.add_column(u'core_baseitem', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)

        # Deleting field 'BaseItem.date_created'
        db.delete_column(u'core_baseitem', 'date_created')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '0310356801944dcaa95bd5cedb8fe1d4'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
