...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseItem.duplicate_status'
        db.add_column(u'core_baseitem', 'duplicate_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebSite.duplicate_status'
        db.add_column(u'core_website', 'duplicate_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SimpleTag.duplicate_status'
        db.add_column(u'core_simpletag', 'duplicate_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseFeed.duplicate_status'
        db.add_column(u'core_basefeed', 'duplicate_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.duplicate_status'
        db.add_column(u'core_language', 'duplicate_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseItem.duplicate_status'
        db.delete_column(u'core_baseitem', 'duplicate_status')

        # Deleting field 'WebSite.duplicate_status'
        db.delete_column(u'core_website', 'duplicate_status')

        # Deleting field 'SimpleTag.duplicate_status'
        db.delete_column(u'core_simpletag', 'duplicate_status')

        # Deleting field 'BaseFeed.duplicate_status'
        db.delete_column(u'core_basefeed', 'duplicate_status')

        # Deleting field 'Language.duplicate_status'
        db.delete_column(u'core_language', 'duplicate_status')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '02482a4c4f2c46a9b9c3020b42e015ba'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.author': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '640', 'null': 'True', 'blank': 'True'}),
            'origin_name': ('django.db.models.fields.CharField', [], {'max_length': '640', 'blank': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'d7875591854c450f98e96155eebb5d33'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'ea5cf3010e764d5184ee664cf6b079d9'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d984753cc8d148d08eb1a44cd76f12dd'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
