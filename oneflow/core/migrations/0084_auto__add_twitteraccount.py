...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_twitteraccount', (
            (u'baseaccount_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.BaseAccount'], unique=True, primary_key=True)),
            ('social_auth', self.gf('django.db.models.fields.related.OneToOneField')(related_name='twitter_account', unique=True, to=orm['default.UserSocialAuth'])),
        ))
        db.send_create_signal('core', ['TwitterAccount'])
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '9146e2359f8842ccb242f1e622d8cf9e'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'e3925671a2ea4ac588356f57e31bd0e4'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'9e0fdc2d06014f72845e65eb736b1313'", 'max_length': '32', 'blank': 'True'}),
