...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_processorcategory', 'maintainer')

        # Deleting field 'ProcessorCategory.needs_parameters'
        db.delete_column(u'core_processorcategory', 'needs_parameters')

        # Adding field 'ProcessorCategory.source_address'
        db.add_column(u'core_processorcategory', 'source_address',
                      self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProcessorCategory.maintainer'
        db.add_column(u'core_processorcategory', 'maintainer',
                      self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessorCategory.needs_parameters'
        db.add_column(u'core_processorcategory', 'needs_parameters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ProcessorCategory.source_address'
        db.delete_column(u'core_processorcategory', 'source_address')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': '730fb8d80e604b369043418e8e39ab3f'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'24d2da7e181346eebcb0fe825d6a175f'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'b4835d21689c4c4186e6f29b7a5cc313'", 'max_length': '32', 'blank': 'True'}),
