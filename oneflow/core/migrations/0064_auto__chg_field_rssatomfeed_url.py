...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RssAtomFeed.url'
        db.alter_column(u'core_rssatomfeed', 'url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=512))

    def backwards(self, orm):

        # Changing field 'RssAtomFeed.url'
        db.alter_column(u'core_rssatomfeed', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'c253536f2dd5497f84dbcd4c8eb2e982'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.nodepermissions': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'1d182b6afbad4af58ddd06805e5d4ebc'", 'max_length': '32', 'blank': 'True'})
        },
        'core.originaldata': {
        ...
        'core.syncnode': {
            ...
            'local_token': ('django.db.models.fields.CharField', [], {'default': "'e31f44bf607c4afaaa3e5301cf6e59a3'", 'max_length': '32', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4ea52b84a2674947b657fdf5198165b3'", 'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'core.userfeeds': {
