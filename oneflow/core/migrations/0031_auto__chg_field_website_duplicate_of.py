...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebSite.duplicate_of'
        db.alter_column(u'core_website', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.WebSite'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WebSite.duplicate_of'
        raise RuntimeError("Cannot reverse this migration. 'WebSite.duplicate_of' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WebSite.duplicate_of'
        db.alter_column(u'core_website', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.WebSite']))
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'e7fb32ed3ec741269b7a015beb37d4e1'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
