...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailContent'
        db.create_table(u'base_emailcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('subject_en', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('subject_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('subject_nt', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('body_en', self.gf('django.db.models.fields.TextField')()),
            ('body_fr', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('body_nt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'base', ['EmailContent'])
    ...
    def backwards(self, orm):
        # Deleting model 'EmailContent'
        db.delete_table(u'base_emailcontent')
