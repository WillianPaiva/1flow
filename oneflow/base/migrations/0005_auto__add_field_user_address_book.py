...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.address_book'
        db.add_column(u'base_user', 'address_book',
                      self.gf('json_field.fields.JSONField')(default=[], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.address_book'
        db.delete_column(u'base_user', 'address_book')
    ...
    models = {
        ...
        u'base.user': {
            ...
            'hash_codes': ('jsonfield.fields.JSONField', [], {'default': "{'unsubscribe': 'ef9079c680fd4b1593df547d3db183df'}", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
