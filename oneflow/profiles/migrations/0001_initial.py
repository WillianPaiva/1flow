...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_userprofile', (
            ...
            ('hash_code', self.gf('django.db.models.fields.CharField')(default='4abfc18f50794e5084ba2a087246dc4a', max_length=32)),
        ))
    ...
    models = {
        ...
        u'profiles.userprofile': {
            ...
            'hash_code': ('django.db.models.fields.CharField', [], {'default': "'d926f78479604a1bb41c8ba5a4673a2b'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
