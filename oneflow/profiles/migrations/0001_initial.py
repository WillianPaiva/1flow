...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_userprofile', (
            ...
            ('hash_code', self.gf('django.db.models.fields.CharField')(default='6d60d8ca06a24bba8cd182986b443eb2', max_length=32)),
    ...
    models = {
        ...
        u'profiles.userprofile': {
            ...
            'hash_code': ('django.db.models.fields.CharField', [], {'default': "'083cfd9d1fcd40968a12bac7a13d9bf2'", 'max_length': '32'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'register_request_data': ('jsonfield.fields.JSONField', [], {'default': '{}', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['base.User']"})
        }
    }
